...
export default function AdminProfileSetupPage() {
  ...
  }, [authLoading, profileLoading, existingProfile, router]);
    ...
    try {
      ...
      await db.transact([
        db.tx.userProfiles[profileId].update({
          ...
          lastName,
          preferredCutlery,
          isAdmin: true, // Admin profile setup always creates admin users
          createdAt: now,
          updatedAt: now,
        }),
      ]);

      toast.success("Profilo amministratore creato con successo!");
      router.push("/admin/dashboard");
    } catch (error) {
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4 py-8">
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            <Save size={20} />
            {isSubmitting ? "Salvataggio..." : "Crea Profilo Admin"}
          </button>
        </form>
      </div>
    </div>
